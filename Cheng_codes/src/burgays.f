...
c
      ...
      dimension data(LENGTH,3),caz(3),tdata(LENGTH)
      complex d(LENG1,3)
...
ccccccccccccccccccccccc test CC cccccccccccccccccccc
      do 12 i=1,1
         eqfile(1:iblank+4)=eqfile(1:iblank)//comp(i,isyntp)
         call rsac1(eqfile,tdata,npts,beg,dt,LENGTH,nerr)
	 call getfhv('USER1',a0,nerr)
	 print *, a0
  12  continue
ccccccccccccccccccccccc test CC ccccccccccccccccccccc
c
...
ccccccccccccccc ADD by CC    cccccc
       if(k11.lt.1) k11=1
       if(k11.lt.1) k12=2801
ccccccccccccccc ADD by CC    ccccccc        Not Sure it's right
...
cccccccccccccccccccccccccc test CC cccccccccccccccccccccccc
       do 13 i=2,2
        outfil(1:iblank+4)=eqfile(1:iblank)//outc(1)
   ...
   13  continue
cccccccccccccccccccccccccccc test CC cccccccccccccccccccccc
