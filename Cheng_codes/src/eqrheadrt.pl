#! /usr/bin/perl
# perl scripts for add head to eqr files.     direct to the .eqr  because of absent of bhz

$DIR= "/home/weizg/data/origin/SDQ_BB_filter1";
#$DIR= "/home/weizg/test1";
...
#print stdout "user0#######################:$user0\n";
    ...
    print STDOUT "The head of $SACFILE was added!\n";
  }
 chdir("..");
