...
c
c    Revised to construct S receiver functions     not correct
c    *** by Ling Chen - 11/24/2003 ***
c
c  *************************************************************************
c
...
c
      ...
      a2(i)=0.
c
c     autocorrelation of radial component and crosscorrelation 
c     between vertical, radial, and tangent components
c
      auto0=auto0+data(i,2)*data(i,2)
      crossr0=crossr0+data(i,2)*data(i,1)
      crosst0=crosst0+data(i,2)*data(i,3)
c   
...
c
      do 20 i=1,npts
      sz(i)=data(i,1)-hz(1)*data(i,2)
      sr(i)=data(i,2)-hr(1)*data(i,2)
      st(i)=data(i,3)-ht(1)*data(i,2) 
   20 continue
c
c     Begin recurive .........
c
...
c
 ...
 101  continue
  18  continue
c
c     normalize receiver function with the maximum of radial component
c
      call minmax(data(1,2),npts,dmin,dmax,dmean)
      do 108 j=1,3
      do 108 i=1,npts
      data(i,j)=data(i,j)/dmax
*      if(i.gt.5950.and.i.le.6050.and.data(i,j).ne.0.)
*     & write(*,*)j,i,data(i,j)
108   continue
c
